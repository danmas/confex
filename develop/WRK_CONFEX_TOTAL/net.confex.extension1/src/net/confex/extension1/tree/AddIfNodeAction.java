...
public class AddIfNodeAction /*extends TranslatableAction*/ implements IViewActionDelegate {

	private NavigationView navigation_view;

	protected String getID() { return "net.confex.extension1.tree.AddIfNodeAction"; }
	protected String getTextKey() {	return "ACTION_AddIfNodeAction"; }
	protected String getIconFileName() { return IfNode.getDefaultImageName();}
	...
	public void run() {
    	...
    	IfNode tree_node = 
    		new IfNode(navigation_view.getConfigTree(),navigation_view);
