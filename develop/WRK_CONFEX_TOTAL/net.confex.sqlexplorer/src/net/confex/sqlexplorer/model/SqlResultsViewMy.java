...
public class SqlResultsViewMy extends ViewPart {

	public static String ID = "net.confex.sqlexplorer.model.SqlResultsViewMy";
     ...
     */
    public void addSQLExecution(AbstractSQLExecutionMy sqlExecution) {
            ...
            public void widgetDisposed(final DisposeEvent e) {
                ...
                BusyIndicator.showWhile(Display.getCurrent(), new Runnable() {
                    ...
                    public void run() {
                        ...
                        AbstractSQLExecutionMy sqlExecution = (AbstractSQLExecutionMy) tabItem.getData();
                        sqlExecution.stop();
