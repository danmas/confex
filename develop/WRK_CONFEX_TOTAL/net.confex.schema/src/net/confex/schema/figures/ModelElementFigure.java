...
public class ModelElementFigure extends Label implements IModelElementFigure {
		...
		public ModelElementFigure(String text) {
			super();
			setText(text);
			setToolTip(tooltip_label);
			
			System.out.println("new ModelElementFigure "+ text);
		}
