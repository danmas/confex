...
public class NodePropertyDialog implements IPropertyDialog {
	...
	public NodePropertyDialog(Shell shell, ITreeNode element) {
		sShell = shell;
	...
	public void createSShell() {
		...
		buttonTest = new Button(sShell, SWT.NONE);
	...
	protected void createSrcButtonPartSShell() {
		readFileButton = new Button(sShell, SWT.NONE);
		...
		saveFileButton = new Button(sShell, SWT.NONE);
		...
		buttonSrcEdit = new Button(sShell, SWT.NONE);
