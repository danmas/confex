...
/**
 * Действие/команда  -  удаление выделенных элементов
 * 
 * @author Roman_Eremeev
 *
 */
public class DeleteAction  extends TranslatableAction {
	
	private IClipboardView clipboard_view;

    protected String getID() { return "net.confex.action.DeleteAction"; }
    protected String getTextKey() { return "MENU_EDIT_DELETE"; }
    protected String getIconFileName() { return "eclipse icons/obj16/delete_obj.gif"; }

    
	public DeleteAction(IClipboardView clipboard_view) {
		super();
