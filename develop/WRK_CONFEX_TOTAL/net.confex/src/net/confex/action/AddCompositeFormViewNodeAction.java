...
public class AddCompositeFormViewNodeAction extends TranslatableAction {
	
    private NavigationView navigation_view;

    protected String getID() { return "net.confex.tree.AddFormViewNodeAction"; }
    protected String getTextKey() { return "ACTION_ADD_FORMVIEWNODE"; }
    protected String getIconFileName() { return CompositeFormViewNode.getDefaultImageName(); }

    
    public AddCompositeFormViewNodeAction(NavigationView navigation_view) {
    	super();
	...
	public void run() {
    	...
    	CompositeFormViewNode tree_node = new CompositeFormViewNode(
