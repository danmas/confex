 ...
 */
public class AddExecTreeNodeAction extends TranslatableAction {
	
	private NavigationView navigation_view;

    protected String getID() { return "net.confex.tree.AddExecTreeNodeAction"; }
    protected String getTextKey() { return "ACTION_ADD_EXECTREENODE"; }
    protected String getIconFileName() { return ExecTreeNode.getDefaultImageName(); }
	
    
	public AddExecTreeNodeAction(NavigationView navigation_view) {
		super();
	...
	public void run() {
		...
		ExecTreeNode tree_node = new ExecTreeNode(
