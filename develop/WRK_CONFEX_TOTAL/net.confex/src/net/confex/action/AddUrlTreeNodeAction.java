...
/**
 * Действие "добавить URL ссылку"
 */
public class AddUrlTreeNodeAction extends TranslatableAction {
	
	private NavigationView navigation_view;

    protected String getID() { return "net.confex.tree.AddUrlTreeNodeAction"; }
    protected String getTextKey() { return "ACTION_ADD_URLTREENODE"; }
    protected String getIconFileName() { return UrlNode.getDefaultImageName(); }
	
    
	public AddUrlTreeNodeAction(NavigationView navigation_view) {
		super();
	...
	public void run() {
    	...
    	UrlNode tree_node = 
    		new UrlNode(navigation_view.getConfigTree(),navigation_view);
