...
public class AddFolderNodeAction extends TranslatableAction {

	private NavigationView navigation_view;

	protected String getID() { return "net.confex.tree.AddFolderNodeAction"; }
	protected String getTextKey() {	return "ACTION_ADD_FOLDERVIEWNODE"; }
	protected String getIconFileName() { return FolderNode.getDefaultImageName();}
	
	
	public AddFolderNodeAction(NavigationView navigation_view) {
		super();
	...
	public void run() {
		...
		FolderNode tree_node = new FolderNode(navigation_view.getConfigTree(),
				navigation_view);
