...
/**
 * Действие "Вставить ветку из буфера обмена"
 */
public class PasteAction extends TranslatableAction {
	    
		private IClipboardView clipboard_view;

	    protected String getID() { return "net.confex.action.PasteAction"; }
	    protected String getTextKey() { return "MENU_EDIT_PASTE"; }
	    protected String getIconFileName() { return "eclipse icons/etool16/paste_edit.gif"; }
	    
	    
		public PasteAction(IClipboardView clipboard_view) {
			super();
