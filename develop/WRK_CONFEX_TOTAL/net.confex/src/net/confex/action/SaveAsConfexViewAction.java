...
public class SaveAsConfexViewAction extends TranslatableAction {
    
	private NavigationView navigation_view;

    protected String getID() { return "net.confex.action.SaveAsConfexViewAction"; }
	...
	public SaveAsConfexViewAction(NavigationView navigation_view) {
		super();
