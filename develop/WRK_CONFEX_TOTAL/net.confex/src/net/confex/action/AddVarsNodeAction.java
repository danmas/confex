...
public class AddVarsNodeAction  extends TranslatableAction {

	private NavigationView navigation_view;

	protected String getID() { return "net.confex.action.AddVarsNodeAction"; }
	protected String getTextKey() {	return "ACTION_ADD_VARSNODE"; }
	protected String getIconFileName() { return VarsNode.getDefaultImageName();}
	
	
	public AddVarsNodeAction(NavigationView navigation_view) {
		super();
	...
	public void run() {
    	...
    	VarsNode tree_node = 
    		new VarsNode(navigation_view.getConfigTree(),navigation_view);
