...
public class AddHtmlCompositeAction extends TranslatableAction {

	private NavigationView navigation_view;

	protected String getID() { return "net.confex.html.AddHtmlCompositeAction"; }
	protected String getTextKey() {	return "ACTION_ADD_HTMLCOMPOSITENODE"; }
	protected String getIconFileName() { return HtmlComposite.getDefaultImageName();}
	
	
	public AddHtmlCompositeAction(NavigationView navigation_view) {
		super();
	...
	public void run() {
    	...
    	HtmlComposite tree_node = new HtmlComposite(
