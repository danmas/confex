 ...
 *     Roman Eremeev - modifications for net.confex properties
 *******************************************************************************/
...
public class WebBrowserView extends ConfexView {
    ...
    //private String tree_node_key = null;
    ...
    //private static final String TAG_TREE_NODE_KEY = "tree_node_key";
    ...
    public void saveState(IMemento memento) {
    	//if(tree_node_key!=null) {
        //	memento.putString(TAG_TREE_NODE_KEY, tree_node_key);
    	//}
     ...
     */
    public void dispose() {
    	//System.out.println("Закрытие WebBrowserView.dispose "+getTitle());
        super.dispose();
    }
...
/*
	public String getTreeNodeKey() {
		return tree_node_key;
	}


	public void setTreeNodeKey(String tree_node_key) {
		this.tree_node_key = tree_node_key;
	}
*/	
}
