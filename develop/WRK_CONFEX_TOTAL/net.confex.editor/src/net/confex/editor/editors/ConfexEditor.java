package net.confex.editor.editors;
 ...
 * </ul>
 */
public class ConfexEditor extends MultiPageEditorPart implements IResourceChangeListener{
	...
	void createView() {
	    	...
	    	String file_name=file.getLocation().toString();
	    	...
	    	try {
				...
				//	.showView(NavigationView.ID,file_name,IWorkbenchPage.VIEW_ACTIVATE);
	        	String id = file_name;
				...
				navigationView.loadFile(file_name);
				page.activate(navigationView);
			} catch (Exception e) {
