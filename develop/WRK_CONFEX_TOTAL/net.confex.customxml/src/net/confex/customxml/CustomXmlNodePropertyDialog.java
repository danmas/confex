...
public class CustomXmlNodePropertyDialog  extends NodePropertyDialog {
	...
	CustomXmlNode element;  //  @jve:decl-index=0:
	...
	protected void prepareRetOk(ITreeNode element) {
		...
		//CustomXmlJava3D c_x = new CustomXmlJava3D();
		//c_x.buildSimpleUniverse(tree_node, null);
	}
	...
	protected void createPart2SShell() {
		...
		custom_xml = new Text(sShell, SWT.WRAP | SWT.MULTI | SWT.V_SCROLL /*| SWT.H_SCROLL*/);
