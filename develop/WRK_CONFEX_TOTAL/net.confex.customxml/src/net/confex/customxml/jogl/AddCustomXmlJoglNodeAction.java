...
public class AddCustomXmlJoglNodeAction   implements IViewActionDelegate {
	...
	protected String getIconFileName() { return CustomXmlJoglNode.getDefaultImageName();}
	...
	public void run(IAction action) {
    	...
    	CustomXmlJoglNode tree_node = new CustomXmlJoglNode(
	...
	public void run() {
    	...
    	CustomXmlJoglNode tree_node = 
    		new CustomXmlJoglNode(navigation_view.getConfigTree(),navigation_view);
