...
public class AddGroovyNodeAction /*extends TranslatableAction*/ implements IViewActionDelegate {

	private NavigationView navigation_view;

	protected String getID() { return "net.confex.groovy.actions.AddGroovyNodeAction"; }
	protected String getTextKey() {	return "ACTION_ADD_GROOVYNODE"; }
	protected String getIconFileName() { return GroovyNode.getDefaultImageName();}
    ...
    public void run(IAction action) {
    	...
    	GroovyNode tree_node = new GroovyNode(
	...
	public void run() {
    	...
    	GroovyNode tree_node = 
    		new GroovyNode(navigation_view.getConfigTree(),navigation_view);
